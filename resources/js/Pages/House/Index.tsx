            ...
            <div className="pb-16">
                {houses.map((house:ShowHouse) => (
                    <div key={house.id} className="rounded-xl relative m-3 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href={house.url} target="_blank" className="font-bold inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            サイトに飛ぶ
